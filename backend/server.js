...
const mongoOptions = {
  ...
  bufferCommands: true, // Enable buffering with proper timeout - better for slow networks
  maxIdleTimeMS: 45000,
  authSource: 'admin'
};

// Set global buffer timeout for slow networks like Render free tier
mongoose.set('bufferTimeoutMS', process.env.NODE_ENV === 'production' ? 120000 : 60000);
